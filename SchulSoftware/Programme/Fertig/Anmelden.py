...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=Anmeldung.anmelden(ort='Anmeldungs-Tisch',zeit=datetime.datetime.now(),incident='ANMELDUNG ERFOLGREICH BEENDET',id=self.var,status='ja'))
        ...
        #self.Button2.configure(command=zurück())
