...
class Toplevel1:
    def __init__(self,top=None, f1=None, f2=None):
        ...
        self.Button1.configure(command= lambda : raise_frame.raise_frame(f2()))
        ...
        self.Button1_1.configure(command= lambda : raise_frame.raise_frame((f1)))
